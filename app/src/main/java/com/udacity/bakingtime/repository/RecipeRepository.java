...
public class RecipeRepository extends RepositoryBase {
    ...
    public Observable<List<RecipeModel>> getRecipeList() {
        ...
        List<RecipeModel> result = mGson.fromJson(CACHED_RECIPES_TEST, new TypeToken<List<RecipeModel>>() { }.getType());
