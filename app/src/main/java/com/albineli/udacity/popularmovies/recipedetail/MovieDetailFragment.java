...
import com.albineli.udacity.popularmovies.recipedetail.review.MovieReviewAdapter;
import com.albineli.udacity.popularmovies.recipedetail.review.MovieReviewListDialog;
import com.albineli.udacity.popularmovies.recipedetail.trailer.MovieTrailerAdapter;
...
public class MovieDetailFragment extends BaseFragment<MovieDetailContract.View> implements MovieDetailContract.View {
    public static MovieDetailFragment getInstance(RecipeModel movieModel) {
    ...
    @Override
    public void showMovieDetail(final RecipeModel movieModel) {
